...
router.get("/users/:id/subscription", authAdmin,async (req, res) => {
  try {
...
router.put("/users/:id",authAdmin, async (req, res) => {
  try {
    ...
    console.log(req.body.subscriptionPlan)
    console.log(req.body.subscriptionStatus)

    
    console.log(req.body.subscriptionExpiry)
    ...
    console.log(`User with ID ${req.params.id} vv  updated successfully.`);
...
router.put("/users/:id", async (req, res) => {
  try {
    ...
    console.log(`Successfully updated user with ID: ${req.params.id}`);
    res.json(updatedUser);
  } catch (error) {
    console.error(`Error updating user ${req.params.id}:`, error.message);
    res.status(400).json({ error: error.message });
