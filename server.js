...
const stripekeys=require('./routes/stripeapikey')
...
const PricingPlan = require('./routes/pricing');
const Admincreate=require('./routes/admin')
...
app.use('/api',admintoutes)
// app.use('/api',landing)
app.use('/api',PricingPlan)
app.use('/api',ImageUpload)
app.use('/api',stripekeys)
app.use('/api/admin',Admincreate)
